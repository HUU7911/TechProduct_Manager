...
public class AdminService implements AdminMapper {
    ...
    private static final String FILE_PATH = "data/admin.bin";

    public AdminService() {
        new File("data").mkdirs();
        loadFromFile();
        if (admins.isEmpty()) {
            String hash = PasswordUtil.hashPassword("admin12345");
    ...
    public void register(Admin admin) {
        ...
        String hashed = PasswordUtil.hashPassword(admin.getPasswordHash());
    ...
    public Admin login(String username, String rawPassword) {
        ...
        if (!PasswordUtil.verifyPassword(rawPassword, admin.getPasswordHash()))
